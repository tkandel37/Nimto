...
export default function DesignsScreen() {
  ...
  return <Screen>
    ...
    {designs.isError ? <EmptyState action={<Button onPress={() => designs.refetch()} title="Try again" />} detail={designs.error instanceof Error ? designs.error.message : "Could not load designs."} title="Could not load designs" /> : null}
    {!designs.isLoading && !designs.isError && !visible.length ? <EmptyState detail="Try a broader search or a different category." title="No designs found" /> : null}

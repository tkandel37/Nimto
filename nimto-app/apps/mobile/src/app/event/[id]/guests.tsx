...
export default function GuestsScreen() {
  ...
  const remove = useMutation({ mutationFn: (inviteeId: string) => apiRequest(`/events/${id}/invitees/${inviteeId}`, { method: "DELETE", token }), onSuccess: () => client.invalidateQueries({ queryKey: ["invitees", id] }) });

...
export default function GuestsScreen() {
  ...
  return <Screen>
    ...
    {query.isError ? <EmptyState action={<Button onPress={() => query.refetch()} title="Try again" />} detail={query.error instanceof Error ? query.error.message : "Could not load invitees."} title="Could not load guest links" /> : null}
    {!query.isLoading && !query.isError && !query.data?.length ? <EmptyState detail="Add names above to create personalized invitation links." icon="♙" title="No invitees yet" /> : null}
